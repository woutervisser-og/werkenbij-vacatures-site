  ...
  switch (blok.type) {
    ...
    case "video_embed":
      return blok.url ? `<div class="blok blok-video">
        <iframe src="${escapeHtml(blok.url)}" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen loading="lazy"></iframe>
      </div>` : "";
...
function renderVacatureHero(vacature, salaris, t) {
  const media = vacature.header.type === "video"
    ? `<div class="vacature-hero-media vacature-hero-video"><iframe src="${escapeHtml(vacature.header.bron)}" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen loading="lazy"></iframe></div>`
